        ...
        <section class="login-register container">
            <ul class="nav nav-tabs mb-5" id="login_register" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link nav-link_underscore active" id="register-tab" data-bs-toggle="tab" href="#tab-item-register" role="tab" aria-controls="tab-item-register" aria-selected="true">Create An Account</a>
                </li>
            </ul>
                ...
                <div class="tab-pane fade show active" id="tab-item-register" role="tabpanel" aria-labelledby="register-tab">
                    <div class="register-form">
                        <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation" novalidate="">
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-control form-control_gray" id="gender" name="gender">
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-control form-control_gray" id="phonecode" name="phonecode">
                            ...
                            <div class="form-floating mb-3">
                                <input id="mobile" type="text" class="form-control form-control_gray @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile') }}" required="" autocomplete="mobile" minlength="10" maxlength="10">
                            ...
                            <div class="form-floating mb-3">
                                <input id="password" type="password" class="form-control form-control_gray" name="password" required="" autocomplete="new-password">
                            ...
                            <div class="customer-option mt-4 text-center">
                                ...
                                <a href="{{ route(name: 'login') }}" class="btn-text js-show-register">Login</a>
                            </div>
                        </form>
                    </div>
                </div>
