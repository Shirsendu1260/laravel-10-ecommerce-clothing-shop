...
@section('content')
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <form action="{{ route('admin_coupon_edit', $coupon->id) }}" method="POST" class="tf-section-2">
                @method('put')
                @csrf
                <div class="wg-box">
                    <fieldset class="name">
                        <div class="body-title mb-10">Coupon Code <span class="tf-color-1">*</span></div>
                        <input class="mb-10 @error('code') is-invalid @enderror" type="text" placeholder="Coupon Code" name="code" tabindex="0" value="{{ $coupon->code }}" aria-required="true">
                        @error('code')
                    ...
                    <fieldset class="description">
                        ...
                        <textarea class="mb-10" name="description" placeholder="Description" tabindex="0" aria-required="true">{{ $coupon->description }}</textarea>
                    ...
                    <div class="gap22 cols">
                        <fieldset class="category">
                            ...
                            <input class="mb-10 @error('max_uses') is-invalid @enderror" type="number" placeholder="Max Uses" name="max_uses" tabindex="0" value="{{ $coupon->max_uses }}" aria-required="true">
                            @error('max_uses')
                        ...
                        <fieldset class="brand">
                            ...
                            <input class="mb-10 @error('max_uses_per_user') is-invalid @enderror" type="number" placeholder="Max Uses per User" name="max_uses_per_user" tabindex="0" value="{{ $coupon->max_uses_per_user }}" aria-required="true">
                ...
                <div class="wg-box">
                    <div class="cols gap22">
                        <fieldset class="name">
                            ...
                            <input class="mb-10 @error('discount') is-invalid @enderror" type="text" placeholder="Discount" name="discount" tabindex="0" value="{{ $coupon->discount }}" aria-required="true">
                            @error('discount')
                                <span class="invalid-feedback fs-5" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <fieldset class="name">
                            ...
                            <input class="mb-10 @error('min_cart_amount') is-invalid @enderror" type="text" placeholder="Minimum Cart Amount" name="min_cart_amount" tabindex="0" value="{{ $coupon->min_cart_amount }}" aria-required="true">
                    ...
                    <div class="cols gap22">
                        <fieldset class="name">
                            ...
                            <input class="mb-10 @error('starts_at') is-invalid @enderror" id="starts-at" type="text" placeholder="Starts At" name="starts_at" tabindex="0" value="{{ $coupon->starts_at }}" aria-required="true">
                            @error('starts_at')
                                <span class="invalid-feedback fs-5" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <fieldset class="name">
                            ...
                            <input class="mb-10 @error('expires_at') is-invalid @enderror" id="expires-at" type="text" placeholder="Expires At" name="expires_at" tabindex="0" value="{{ $coupon->expires_at }}" aria-required="true">
                            @error('expires_at')
                                <span class="invalid-feedback fs-5" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
