...
@section('content')
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <!-- new-category -->
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('admin_brand_create') }}" method="POST">
                    @csrf
                    <fieldset class="name">
                        <div class="body-title">Brand Name <span class="tf-color-1">*</span></div>
                        <input class="flex-grow me-3 @error('name') is-invalid @enderror" type="text" placeholder="Brand Name" name="name" value="{{ old('name') }}" tabindex="0" value="" aria-required="true">
                        @error('name')
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow me-3 @error('slug') is-invalid @enderror" type="text" placeholder="Brand Slug" name="slug" value="{{ old('slug') }}" tabindex="0" value="" aria-required="true" readonly>
                        @error('slug')
                            <span class="invalid-feedback fs-5" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
