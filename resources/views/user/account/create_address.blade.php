                                          ...
                                          <div class="row">
                                                  ...
                                                  <div class="form-floating my-3">
                                                      <select class="form-control form-control_gray @error('country') is-invalid @enderror" id="country" name="country">
                                                          ...
                                                          @foreach($countries as $country)
                                                              <option value="{{ $country->name }}" {{ !empty(old('country')) ? 'selected' : '' }}>{{ $country->name }}</option>
                                                          @endforeach
                                                      </select>
                                              ...
                                              <div class="col-md-6">
                                                  <div class="form-check">
                                                      <input class="form-check-input" type="checkbox" value="1" id="is_default" name="is_default" {{ !empty(old('is_default')) ? 'checked' : '' }}>
